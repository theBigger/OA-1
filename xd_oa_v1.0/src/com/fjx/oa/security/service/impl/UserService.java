...
public class UserService extends BaseAbstractService<User> implements IUserService {
	...
	public EasyUIPagination<List<Map>> queryPageUsers() throws Exception {
		...
		String hql = "select " +
				" new map(u.id as id,u.username as username,u.person.name as name,u.person.sex as sex,u.person.duty as duty,u.person.org.id as org_id,u.person.org.name as org_name,u.createTime as createTime, u.expireTime as expireTime) " +
				" from User u " +
				" where 1=1";
